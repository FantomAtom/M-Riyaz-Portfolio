    ...
    >
      ...
      >
        <div className="relative">
          ...
          <button
            onClick={close}
            className="fixed top-4 right-4 z-[9999] md:absolute md:z-10 bg-white text-red-500 w-10 h-10 rounded-full shadow-lg flex items-center justify-center hover:bg-red-100 transition-all"
          >
            <svg
